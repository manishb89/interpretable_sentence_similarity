...
if __name__ == '__main__':
    ...
    for rel in relation_types:
        cache_path = '{}/cn_images/combined_cn_resource_{}_processed.json'.format(args.data_dir, rel)
    ...
    chunk1_path = '{}/STSint.input.images.sent1.chunk.txt'.format(train_dir)
    chunk2_path = '{}/STSint.input.images.sent2.chunk.txt'.format(train_dir)
    fp1 = '{}/STSint.input.images.sent1.txt'.format(train_dir)
    fp2 = '{}/STSint.input.images.sent2.txt'.format(train_dir)
    align_file = '{}/STSint.input.images.wa'.format(train_dir)
    ...
    # out_path = train_dir + '/STSint.input.images.fol.cn_all_resources_content_only.json'
    ...
    for match_type in match_types:
        ...
        out_path = '{}/STSint.input.images.fol.cn_combined_{}_content_only.json'.format(train_dir, match_type)
        with open(out_path, 'w') as fp:
    ...
    chunk1_path = '{}/STSint.testinput.images.sent1.chunk.txt'.format(test_dir)
    chunk2_path = '{}/STSint.testinput.images.sent2.chunk.txt'.format(test_dir)
    fp1 = '{}/STSint.testinput.images.sent1.txt'.format(test_dir)
    fp2 = '{}/STSint.testinput.images.sent2.txt'.format(test_dir)
    align_file = '{}/STSint.testinput.images.wa'.format(test_dir)
    ...
    # out_path = test_dir + '/STSint.testinput.images.fol.cn_all_resources_content_only.json'
    # with open(out_path, 'w') as fp:
    #     json.dump(res, fp)
    ...
    for match_type in match_types:
        ...
        out_path = '{}/STSint.testinput.images.fol.cn_combined_{}_content_only.json'.format(test_dir, match_type)
        with open(out_path, 'w') as fp:
            json.dump(comb_matches, fp)
